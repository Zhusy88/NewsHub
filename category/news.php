...
<div style="padding-bottom: 1.5rem;">
      ...
      <div class="c-archive-header o-full-width" style="background-image:url('../img/News/news.jpg')">
            <div class="o-wrapper o-wrapper--large">
            <h1 class="c-archive-header__title">时事</h1>
            <p class="c-archive-header__desc"></p><p>窗外是番怎样的光景呢？</p>
      <p></p>
          </div>
      </div>
...
function getData(config, offset,size){
  ...
  config.isAjax = true;
  $.ajax({
    url: "../php/getNews/getNewsNews.php",  
    type: "POST",
    dataType: "json",
