...
<div style="padding-bottom: 1.5rem;">
      ...
      <div class="c-archive-header o-full-width" style="background-image:url('../img/News/sports.jpg')">
            <div class="o-wrapper o-wrapper--large">
            <h1 class="c-archive-header__title">体育</h1>
            <p class="c-archive-header__desc"></p><p>我爱运动，运动使我快乐</p>
      <p></p>
          </div>
      </div>
...
function getData(config, offset,size){
  ...
  config.isAjax = true;
  $.ajax({
    url: "../php/getNews/getSportsNews.php",  
    type: "POST",
    dataType: "json",
