...
<div style="padding-bottom: 1.5rem;">
      ...
      <div class="c-archive-header o-full-width" style="background-image:url('../img/News/ent.jpg')">
            <div class="o-wrapper o-wrapper--large">
            <h1 class="c-archive-header__title">娱乐</h1>
            <p class="c-archive-header__desc"></p><p>但是我要说：娱乐至死</p>
      <p></p>
          </div>
      </div>
...
function getData(config, offset,size){
  ...
  config.isAjax = true;
  $.ajax({
    url: "../php/getNews/getEntNews.php",  
    type: "POST",
    dataType: "json",
